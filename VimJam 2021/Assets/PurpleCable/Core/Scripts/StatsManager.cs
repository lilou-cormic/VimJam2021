...
namespace PurpleCable
{
    ...
    public static class StatsManager
    {
        ...
        /// <summary>
        /// Submits and achievement (stat set to 1)
        /// </summary>
        /// <param name="achievementName">The achievement [stat] name</param>
        public static void SubmitAchivement(string achievementName)
        {
            SubmitStat(achievementName, 1);
        }
